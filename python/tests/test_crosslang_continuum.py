...
RUNNER = next(
    (p for p in (_ROOT / "research" / "stock-constraint" / "tools" / "sin_reference.js",  # monorepo
...
# eqcert/tests/test-single-source.js exists to catch, and no gate reaches across
