...
/* verify.js — independent re-verification (Lane B, claim 4) of the machine-checkable
   ...
   BigInt rationals (eqcert/src/rational.js) where the question is an identity or a
   tie, outward-rounded intervals (eqcert/src/interval.js) + the Krawczyk operator
   (eqcert/src/radii.js) where it is a root enclosure:
...
const EQ = path.join(__dirname, '..', '..', '..', 'eqcert', 'src');
