...
/* verify.js — independent certified re-verification (Lane B, claim 6) of the
   ...
   critical points: 24 pairwise-disjoint boxes, each carrying
     (a) a Krawczyk certificate (eqcert/src/radii.js) of existence AND local
   ...
   ARITHMETIC. eqcert/src/interval.js (outward-rounded double intervals),
   eqcert/src/transcendental.js (sound interval exp/log), eqcert/src/rational.js
...
const EQ = p => require(path.join(__dirname, '..', '..', '..', 'eqcert', 'src', p));
