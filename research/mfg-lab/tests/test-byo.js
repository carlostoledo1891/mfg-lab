...
const BYO = [require('./_root.js').rootPath('lab', 'mfg-byo.js')]       /* export */
            .find(f => fs.existsSync(f));
if (!BYO) {
  console.error('test-byo.js: lab/mfg-byo.js was not found from ' + __dirname);
  console.error('  expected it at the tree root (M5b moved the instruments there).');
  process.exit(2);
}
const K = require(BYO);
...
console.log('   lab/mfg-byo.js  sha256:' + sha(BYO));
