...
cwd (the battery lives in research/mfg-lab/tests/, the artifact one level up).
"""
import pathlib, sys, json
from playwright.sync_api import sync_playwright

_HERE = pathlib.Path(__file__).resolve().parent
# mfg-lab.html again since 2026-08-21: `index.html` existed only so a DIRECTORY could answer to
# its own name, and a page's path IS its URL after the structure migration.
...
with sync_playwright() as p:
    ...
    #    index.html (114 KB, the HOME page — long, and entirely static)
