...
/* In-lab routes. Prose tabs move to site pages (/defects, /program, /certificates);
...
const HTML = process.env.MFG_HTML || require('path').resolve(__dirname, '..', 'index.html');
...
(() => {
  const candidates = [
    path.join(__dirname, '..', '..', '..', 'site', 'certificates.html'), // monorepo
    path.join(__dirname, '..', '..', 'certificates.html'),               // public export root
  ];
