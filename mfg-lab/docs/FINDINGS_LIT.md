...
## Method
M1 kernel extracted brace-balanced from mfg-lab/index.html into `kernel_param.js`
...
1. **A prior planning note recorded that MF-OMO "bounds exploitability by the
   ...
   **RULES: the abstract is not the paper — never conclude a body-level claim
   ...
   here.**
2. **"Uncited" was itself half wrong.** mfg-lab/index.html already named `MF-OMO,
