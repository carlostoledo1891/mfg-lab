...
/* M5b, 2026-07-28: was `'../../../eqcert/...'`. See the note in order-study.js — the count was
   correct in the monorepo and reached above the export root in the shipped tree; lab/ at the
   root of both trees makes one `..` correct in both. */
