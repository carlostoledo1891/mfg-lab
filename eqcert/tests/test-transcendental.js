...
/* test-transcendental.js — battery for src/transcendental.js
   ...
   Run: node eqcert/tests/test-transcendental.js
*/
'use strict';
const path = require('path');
const I = require(path.join(__dirname, '..', 'src', 'interval.js'));
const Q = require(path.join(__dirname, '..', 'src', 'rational.js'));
const T = require(path.join(__dirname, '..', 'src', 'transcendental.js'));
const { iv } = I;
