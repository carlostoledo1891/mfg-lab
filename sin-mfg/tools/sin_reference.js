...
/* TWO TREES, TWO LAYOUTS — measured 2026-08-04. This resolved one path only,
   ...
   ships site/technical-reports/stock-constraint.html as technical-reports/stock-constraint.html,
   while this file itself ships under sin-mfg/tools/. So the export's copy of the
...
const CANDIDATES = (process.env.SIN_HTML ? [process.env.SIN_HTML] : [
  path.resolve(__dirname, '..', 'sin-mfg.html'),                              /* monorepo: research/stock-constraint/ */
  path.resolve(__dirname, '..', '..', 'technical-reports', 'stock-constraint.html'), /* export: the renaming move */
